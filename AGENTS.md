...
- Docker workflows authenticate with `vars.DOCKER_USER` and `secrets.DOCKER_PAT`, then use Docker Build Cloud endpoint `eduardoalco/build`. Preserve architecture-specific nginx compiler flags.
